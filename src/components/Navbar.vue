<template>
    <!-- component -->
    <div class="h-full flex  justify-center bg-gray-100 border-e-2 ">
        <div class="flex w-full max-w-xs p-4 bg-white">
            <ul class="flex flex-col w-full">
                ...
                <li class="my-px">
                    <span class="flex font-medium text-sm text-gray-400 px-4 my-4 uppercase">Pqrs</span>
                </li>
                <li class="my-px">
                    <a href="#" class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600 hover:bg-gray-100">
                        ...
                        <span class="ml-3">Dependencias</span>
                    </a>
                </li>
                <li class="my-px">
                    <a href="#" class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600 hover:bg-gray-100">
                ...
                <li class="my-px">
                    <a href="#" class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600 hover:bg-gray-100">
                        ...
                        <span class="ml-3">Seguimiento</span>
                        <span
                            class="flex items-center justify-center text-sm text-gray-500 font-semibold bg-gray-200 h-6 px-2 rounded-full ml-auto">1k</span>
                    </a>
                </li>
